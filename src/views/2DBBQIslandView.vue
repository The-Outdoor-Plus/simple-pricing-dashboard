          ...
          <StepPanel v-slot="{ activateCallback }" value="5">
            ...
            <div class="w-full">
              ...
              <IslandPreview
                ...
                :top-color="getSelectedTopStyleColor"
                :bottom-color="getSelectedBottomStyleColor"
    ...
    <div class="w-full mt-4">
      ...
      >
        <div class="w-full flex mb-4">
          ...
          <h3 class="w-4/12 lg:w-3/12 text-xl font-semibold mb-4 text-right px-3">MSRP*</h3>
        </div>
        <Divider />
...
const mainAppliances = ref([
  {
    ...
    image:
      'https://www.dropbox.com/scl/fi/rqsjofmqktsz61wofv795/36-Grill-Closed.jpg?rlkey=7rr7l3k6xycf9983ch7ndeekl&st=jimedmcv&raw=1',
    type: 'appliance',
    section: 'top',
    price: 1436,
    width: 36,
  ...
  },
  {
    ...
    type: 'appliance',
    description: '13" Double Side Burner',
    price: 563,
    width: 13,
  },
]);
...
const islandLength = computed(() => {
  return length.value ? length.value * 12 : 0;
});
