...
<p>This code is valid for 10 minutes and can only be used once. If this Sign-In attempt was not initiated by you, please reset your TOP Dealer Portal Account. To reset your password please go to the following link: <a href="${siteUrl}/update-password">Portal - Password Reset</a></p>
